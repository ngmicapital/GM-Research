...
| Missing content (not stale, just absent) | `rabbit-hole.html` absent for **2026-06-28** and **2026-07-01**. ⚠ CORRECTED by Fable's wide-read (2026-07-02): rabbit-hole published **7 days/week from April to 2026-06-27** (23 weekend editions), then its cron became Mon–Fri at exactly the token-cut date — so 06-28 (a Sunday) is schedule-design under the new cadence, NOT a failure; only 07-01 (Wed) is a genuine race casualty. Checks now expect Mon–Fri; dc to confirm whether the weekend drop was intended. | n/a — noted so Fable doesn't read the gap as a bug in the pipeline. |
